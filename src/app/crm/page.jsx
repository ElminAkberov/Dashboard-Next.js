        ...
        <div>
            ...
            <div className="bg-white p-5 text-[#64748b]">
                ...
                <div className="grid grid-cols-12 mb-8 items-center">
                    <div className="col-span-3 flex items-center gap-x-2 text-[#64748b] font-medium"><img src="/assets/img/user1.webp" width={44} height={44} alt="" /><span className='max-[1200px]:hidden'>Charlie Donin</span> </div>
                ...
                <div className="grid grid-cols-12 mb-8 items-center">
                    <div className="col-span-3 flex items-center gap-x-2 text-[#64748b] font-medium"><img src="/assets/img/user2.webp" width={44} height={44} alt="" /><span className='max-[1200px]:hidden'>Makenna Carder</span> </div>
                ...
                <div className="grid grid-cols-12 mb-8 items-center">
                    <div className="col-span-3 flex items-center gap-x-2 text-[#64748b] font-medium"><img src="/assets/img/user3.webp" width={44} height={44} alt="" /><span className='max-[1200px]:hidden'>Talan Dokidis</span> </div>
                    <div className="col-span-3 max-[400px]:col-span-4 relative">
                        rtaylor@aol.com</div>
                    <div className="col-span-3 max-md:hidden">25 Dec 2024 - 28 Dec 2024</div>
                    <div className="max-[1200px]:hidden col-span-1">
                ...
                <div className="grid grid-cols-12 mb-8 items-center">
                    <div className="col-span-3 flex items-center gap-x-2 text-[#64748b] font-medium"><img src="/assets/img/user4.webp" width={44} height={44} alt="" /><span className='max-[1200px]:hidden'>Cheyenne Levin</span> </div>
                ...
                <div className="grid grid-cols-12 mb-8 items-center">
                    <div className="col-span-3 flex items-center gap-x-2 text-[#64748b] font-medium"><img src="/assets/img/user5.webp" width={44} height={44} alt="" /><span className='max-[1200px]:hidden'>James Aminoff</span> </div>
