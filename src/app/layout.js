...
export default function RootLayout({ children }) {
  ...
  let [group, setGroup] = useState("Dashboard")
  ...
  useEffect(() => {
    ...
    document.title = `Next.js ${pathname.split("/")[1].charAt(0).toUpperCase() + pathname.slice(2)} Dashboard | TailAdmin`;
  }, [pathname]);

  const handleOpen = (name) => {
    let target = name.target.innerText
    setGroup(target)
    setOpen(prev => ({
      ...prev,
      [target]: !prev[target]
  ...
  const links = [
    ...
    { href: "/analytics", label: "Analytics", badge: "Pro" },
    { href: "/marketing", label: "Marketing", badge: "Pro" },
    { href: "/crm", label: "CRM", badge: "Pro" },
    { href: "/stocks", label: "Stocks", badge: "Pro" }
  ];
  ...
  return (
    <html lang="en">
      <body>
        <>
          <div className="flex satoshi">
            <div className={`py-[26px] z-[90]  px-[24px] scrolls  fixed overflow-y-scroll h-[100vh] bg-[#1C2434] ${close ? "left-0" : "max-lg:left-[-290px]"}  w-[290px]  duration-300`}>
              <div className="flex items-center justify-between">
                <Link href={"/"}>
                  <Image width={180} height={20} src="/assets/img/logo.svg" alt="logo" />
                </Link>
                <svg onClick={() => { setClose(!close) }} className="fill-current lg:hidden" width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19 8.175H2.98748L9.36248 1.6875C9.69998 1.35 9.69998 0.825 9.36248 0.4875C9.02498 0.15 8.49998 0.15 8.16248 0.4875L0.399976 8.3625C0.0624756 8.7 0.0624756 9.225 0.399976 9.5625L8.16248 17.4375C8.31248 17.5875 8.53748 17.7 8.76248 17.7C8.98748 17.7 9.17498 17.625 9.36248 17.475C9.69998 17.1375 9.69998 16.6125 9.36248 16.275L3.02498 9.8625H19C19.45 9.8625 19.825 9.4875 19.825 9.0375C19.825 8.55 19.45 8.175 19 8.175Z" fill="#49566A"></path></svg>
              </div>
              <div className="mt-[36px]">
                <h3 className='text-[14px] font-semibold text-[#8A99af] ml-4 mb-4'>MENU</h3>
                <div className="">
                  <div onClick={(e) => handleOpen(e)} id="dash" className={`flex ${group == "Dashboard" ? "bg-[#333a48]" : ""}  cursor-pointer items-center justify-between hover:bg-[#333a48] px-4 py-2 text-[#dee4ee]`}>
                    ...
                    <div className="">
                      <svg className={`${open["Dashboard"] && 'rotate-180'} fill-current `} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.41107 6.9107C4.73651 6.58527 5.26414 6.58527 5.58958 6.9107L10.0003 11.3214L14.4111 6.91071C14.7365 6.58527 15.2641 6.58527 15.5896 6.91071C15.915 7.23614 15.915 7.76378 15.5896 8.08922L10.5896 13.0892C10.2641 13.4147 9.73651 13.4147 9.41107 13.0892L4.41107 8.08922C4.08563 7.76378 4.08563 7.23614 4.41107 6.9107Z" fill=""></path></svg>
                    </div>
                  </div>
                  <div className={`${open["Dashboard"] ? "hidden" : 'block'} mt-4 mb-5 px-[45px] satoshi relative text-[#8A99af]`}>
                    {links.map((link) => (
                      <Link key={link.href} href={link.href} className={`block my-2 ${link.href.toLocaleLowerCase() == pathname.toLocaleLowerCase() ? "text-white" : ""}`}>
                        {link.label}
                        {link.badge && (
                          <span className={`text-white absolute text-xs bg-[#3c50e0] rounded font-medium right-4  py-1 px-2`}>
                            {link.badge}
                          </span>
                        )}
                      </Link>
                ...
                <div className="">
                  <div onClick={(e) => handleOpen(e)} className={`${group == "Task" ? "bg-[#333a48]" : ""} flex mb-2 cursor-pointer items-center justify-between hover:bg-[#333a48] px-4 py-2 text-[#dee4ee]`}>
                    <div className="flex items-center gap-2.5 ">
                    ...
                    <div className="">
                      <svg className={` fill-current ${open["Task"] && 'rotate-180'}`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.41107 6.9107C4.73651 6.58527 5.26414 6.58527 5.58958 6.9107L10.0003 11.3214L14.4111 6.91071C14.7365 6.58527 15.2641 6.58527 15.5896 6.91071C15.915 7.23614 15.915 7.76378 15.5896 8.08922L10.5896 13.0892C10.2641 13.4147 9.73651 13.4147 9.41107 13.0892L4.41107 8.08922C4.08563 7.76378 4.08563 7.23614 4.41107 6.9107Z" fill=""></path></svg>
                    </div>
                  </div>
                  <div className={`${open["Task"] ? "block" : 'hidden'}  mt-4 mb-5 px-[45px] satoshi relative text-[#8A99af]`}>
                    <Link href={"/"} className='block my-2'>List <span className='absolute text-xs bg-[#3c50e0] rounded font-medium right-4 text-white py-1 px-2'>Pro</span></Link>
                    <Link href={"/"} className='block my-2'>Karban <span className='absolute text-xs bg-[#3c50e0] rounded font-medium right-4 text-white py-1 px-2'>Pro</span></Link>
                  </div>
                </div>
                <div className="">
                  <div onClick={(e) => handleOpen(e)} className={`${group == "Forms" ? "bg-[#333a48]" : ""} flex mb-2 cursor-pointer items-center justify-between hover:bg-[#333a48] px-4 py-2 text-[#dee4ee]`}>
                    <div className="flex items-center gap-2.5 ">
                      <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.43425 7.5093H2.278C2.44675 7.5093 2.55925 7.3968 2.58737 7.31243L2.98112 6.32805H5.90612L6.27175 7.31243C6.328 7.48118 6.46862 7.5093 6.58112 7.5093H7.453C7.76237 7.48118 7.87487 7.25618 7.76237 7.03118L5.428 1.4343C5.37175 1.26555 5.3155 1.23743 5.14675 1.23743H3.88112C3.76862 1.23743 3.59987 1.29368 3.57175 1.4343L1.153 7.08743C1.0405 7.2843 1.20925 7.5093 1.43425 7.5093ZM4.47175 2.98118L5.3155 5.17493H3.59987L4.47175 2.98118Z" fill=""></path><path d="M10.1249 2.5031H16.8749C17.2124 2.5031 17.5218 2.22185 17.5218 1.85623C17.5218 1.4906 17.2405 1.20935 16.8749 1.20935H10.1249C9.7874 1.20935 9.47803 1.4906 9.47803 1.85623C9.47803 2.22185 9.75928 2.5031 10.1249 2.5031Z" fill=""></path><path d="M16.8749 6.21558H10.1249C9.7874 6.21558 9.47803 6.49683 9.47803 6.86245C9.47803 7.22808 9.75928 7.50933 10.1249 7.50933H16.8749C17.2124 7.50933 17.5218 7.22808 17.5218 6.86245C17.5218 6.49683 17.2124 6.21558 16.8749 6.21558Z" fill=""></path><path d="M16.875 11.1656H1.77187C1.43438 11.1656 1.125 11.4469 1.125 11.8125C1.125 12.1781 1.40625 12.4594 1.77187 12.4594H16.875C17.2125 12.4594 17.5219 12.1781 17.5219 11.8125C17.5219 11.4469 17.2125 11.1656 16.875 11.1656Z" fill=""></path><path d="M16.875 16.1156H1.77187C1.43438 16.1156 1.125 16.3969 1.125 16.7625C1.125 17.1281 1.40625 17.4094 1.77187 17.4094H16.875C17.2125 17.4094 17.5219 17.1281 17.5219 16.7625C17.5219 16.3969 17.2125 16.1156 16.875 16.1156Z" fill="white"></path></svg>
                      <p>Forms</p>
                    </div>
                    <div className="">
                      <svg className={`fill-current ${open["Forms"] && 'rotate-180'}`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.41107 6.9107C4.73651 6.58527 5.26414 6.58527 5.58958 6.9107L10.0003 11.3214L14.4111 6.91071C14.7365 6.58527 15.2641 6.58527 15.5896 6.91071C15.915 7.23614 15.915 7.76378 15.5896 8.08922L10.5896 13.0892C10.2641 13.4147 9.73651 13.4147 9.41107 13.0892L4.41107 8.08922C4.08563 7.76378 4.08563 7.23614 4.41107 6.9107Z" fill=""></path></svg>
                    </div>
                  </div>
                  <div className={` ${open["Forms"] ? "block" : 'hidden'} mt-4 mb-5 px-[45px] satoshi relative text-[#8A99af]`}>
                    <Link href={"/"} className='block my-2'>Form Elements </Link>
                    <Link href={"/"} className='block my-2'>Pro Form Elements <span className='absolute text-xs bg-[#3c50e0] rounded font-medium right-4 text-white py-1 px-2'>Pro</span></Link>
                    <Link href={"/"} className='block my-2'>Form Layout </Link>
                    <Link href={"/"} className='block my-2'>Pro Form Layout <span className='absolute text-xs bg-[#3c50e0] rounded font-medium right-4 text-white py-1 px-2'>Pro</span></Link>
                  </div>
                </div>
                <div className="">
                  <div onClick={(e) => handleOpen(e)} className={`${group == "Tables" ? "bg-[#333a48]" : ""} flex mb-2 cursor-pointer items-center justify-between hover:bg-[#333a48] px-4 py-2 text-[#dee4ee]`}>
                    <div className="flex items-center gap-2.5 ">
                    ...
                    <div className="">
                      <svg className={`fill-current ${open["Tables"] && 'rotate-180'}`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.41107 6.9107C4.73651 6.58527 5.26414 6.58527 5.58958 6.9107L10.0003 11.3214L14.4111 6.91071C14.7365 6.58527 15.2641 6.58527 15.5896 6.91071C15.915 7.23614 15.915 7.76378 15.5896 8.08922L10.5896 13.0892C10.2641 13.4147 9.73651 13.4147 9.41107 13.0892L4.41107 8.08922C4.08563 7.76378 4.08563 7.23614 4.41107 6.9107Z" fill=""></path></svg>
                    </div>
                  </div>
                  <div className={`${open["Tables"] ? "block" : 'hidden'} mt-4 mb-5 px-[45px] satoshi relative text-[#8A99af]`}>
                    <Link href={"/"} className='block my-2'>Tables</Link>
                    <Link href={"/"} className='block my-2'>Pro Tables <span className='absolute text-xs bg-[#3c50e0] rounded font-medium right-4 text-white py-1 px-2'>Pro</span></Link>
                  </div>
                </div>
                <div className="">
                  <div onClick={(e) => handleOpen(e)} className={`${group == "Pages" ? "bg-[#333a48]" : ""} flex mb-2 cursor-pointer items-center justify-between hover:bg-[#333a48] px-4 py-2 text-[#dee4ee]`}>
                    <div className="flex items-center gap-2.5 ">
                    ...
                    <div className="">
                      <svg className={`fill-current ${open["Pages"] && 'rotate-180'}`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.41107 6.9107C4.73651 6.58527 5.26414 6.58527 5.58958 6.9107L10.0003 11.3214L14.4111 6.91071C14.7365 6.58527 15.2641 6.58527 15.5896 6.91071C15.915 7.23614 15.915 7.76378 15.5896 8.08922L10.5896 13.0892C10.2641 13.4147 9.73651 13.4147 9.41107 13.0892L4.41107 8.08922C4.08563 7.76378 4.08563 7.23614 4.41107 6.9107Z" fill=""></path></svg>
                    </div>
                  </div>
                  <div className={`${open["Pages"] ? "block" : 'hidden'} mt-4 mb-5 px-[45px] satoshi relative text-[#8A99af]`}>
                    <Link href={"/"} className='block my-2'>Settings</Link>
                    <Link href={"/"} className='block my-2'>File Manager <span className='absolute text-xs bg-[#3c50e0] rounded font-medium right-4 text-white py-1 px-2'>Pro</span></Link>
                ...
                <h3 className='text-[14px] font-semibold text-[#8A99af] ml-4 mb-4'>SUPPORT</h3>

                <div className="relative mb-2">
                  <div className="flex items-center justify-between hover:bg-[#333a48] px-4 py-2 text-[#dee4ee]">
                    <div className="flex items-center gap-2.5 ">
                      <svg className="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.7499 2.75208H2.2499C1.29365 2.75208 0.478027 3.53957 0.478027 4.52395V13.6364C0.478027 14.5927 1.26553 15.4083 2.2499 15.4083H15.7499C16.7062 15.4083 17.5218 14.6208 17.5218 13.6364V4.49583C17.5218 3.53958 16.7062 2.75208 15.7499 2.75208ZM15.7499 4.0177C15.778 4.0177 15.8062 4.0177 15.8343 4.0177L8.9999 8.4052L2.16553 4.0177C2.19365 4.0177 2.22178 4.0177 2.2499 4.0177H15.7499ZM15.7499 14.0865H2.2499C1.96865 14.0865 1.74365 13.8615 1.74365 13.5802V5.2552L8.3249 9.47395C8.52178 9.61457 8.74678 9.67083 8.97178 9.67083C9.19678 9.67083 9.42178 9.61457 9.61865 9.47395L16.1999 5.2552V13.6083C16.2562 13.8896 16.0312 14.0865 15.7499 14.0865Z" fill=""></path></svg>
                      <p>Messages</p>
                    </div>
                    <div className="">
                      <span className='absolute text-xs bg-[#3c50e0] rounded top-2 font-medium right-14 text-white py-1 px-2'>5</span>
                      <span className='absolute text-xs bg-[#3c50e0] rounded top-2 font-medium right-4 text-white py-1 px-2'>Pro</span>
                    </div>
                  </div>
                </div>
                <div className="relative mb-2">
            ...
            <div className="lg:ml-[290px] duration-300 w-full  bg-[#F1F5F9]">
              <div className='bg-white shadow-2 flex justify-between items-center px-4 py-4 shadow-2 md:px-6 2xl:px-11 '>
              ...
              <div className="px-4  py-4 md:px-6 2xl:px-11 ">
                {
                  loading ?
                    <div className="h-[84.5vh]  flex justify-center items-center">
                      <p>
                      <ClipLoader size={50} speedMultiplier={0.75} color="#3C50E0" />
                      </p>
                    </div>
                    :
                    children
